const translations = {
  zh: {
    ...
    themeLabel: '切换深浅色',
    aboutEyebrow: '个人概览',
    aboutTitle: '进一步了解我。<br><em>不止于简历。</em>',
    hello: '你好，我是',
    ...
    timeOne: '2024 — 至今',
    jobOne: '你的职位',
    companyOne: '公司 / 组织名称 · Toronto',
    achievementOne: '用一句话说明你解决的问题、采取的行动和可量化的成果。',
    jobTwo: '上一段职位',
    companyTwo: '公司 / 组织名称 · 城市',
    achievementTwo: '突出一项最能证明能力或成长的代表性贡献。',
    experienceToggleLabel: '展开或收起经历详情',
    education: '教育背景',
    degree: '你的专业与学位',
    school: '学校名称 · 城市',
    currentFocus: '当前关注',
    focusText: '在这里写下你正在学习、研究或希望深入发展的方向。',
    projectsEyebrow: '精选项目',
    projectsTitle: '项目不用很多，<br><em>留下代表作。</em>',
    projectOneType: '数据产品 · 2026',
    projectOneTitle: '项目名称一',
    projectOneBody: '简要说明项目解决的问题、你的角色和最终成果。',
    viewProject: '查看案例',
    projectTwoType: '研究项目 · 2025',
    projectTwoTitle: '项目名称二',
    projectTwoLabel: '查看项目二',
    projectThreeType: '个人作品 · 2025',
    projectThreeTitle: '项目名称三',
    ...
    skillGroupLabel: '技能选择',
    skillAnalysis: '数据分析',
    skillResearch: '用户研究',
    skillManagement: '项目管理',
    skillStory: '叙事表达',
    technical: '技术与工具',
    communication: '沟通与协作',
    ...
    issuerTwo: '颁发机构',
    issuerThree: '学校或组织',
    resumeCardTitle: '需要更完整的信息？',
    downloadFull: '下载完整简历',
    footerNote: '简洁、专注、易于浏览',
    tabHint: '点击左侧栏目切换内容',
    dialogCloseLabel: '关闭项目详情',
    dialogRole: '我的角色',
    dialogOutcome: '核心成果',
    dialogTools: '使用工具',
    dialogNote: '这里可以继续补充项目链接、截图或完整案例。',
  ...
  en: {
    ...
    aboutTitle: 'Get to know me.<br><em>Beyond the résumé.</em>',
    hello: "Hello, I'm",
    ...
    timeOne: '2024 — Present',
    jobOne: 'Your Current Role',
    companyOne: 'Company / Organization · Toronto',
    achievementOne: 'Summarize the problem, your action, and a measurable result in one sentence.',
    jobTwo: 'Previous Role',
    companyTwo: 'Company / Organization · City',
    achievementTwo: 'Highlight one contribution that best demonstrates your ability or growth.',
    experienceToggleLabel: 'Expand or collapse experience details',
    education: 'Education',
    degree: 'Your Degree & Major',
    school: 'School Name · City',
    currentFocus: 'Current focus',
    focusText: 'Add what you are learning, researching, or hoping to explore more deeply.',
    projectsEyebrow: 'Selected projects',
    projectsTitle: 'Fewer projects.<br><em>Stronger signals.</em>',
    projectOneType: 'Data Product · 2026',
    projectOneTitle: 'Project Name One',
    projectOneBody: 'Briefly explain the problem, your role, and the final outcome.',
    viewProject: 'View case study',
    projectTwoType: 'Research Project · 2025',
    projectTwoTitle: 'Project Name Two',
    projectTwoLabel: 'View project two',
    projectThreeType: 'Independent Work · 2025',
    projectThreeTitle: 'Project Name Three',
    ...
    issuerOne: 'Issuing organization',
    issuerTwo: 'Issuing organization',
    issuerThree: 'School or organization',
    resumeCardTitle: 'Need the complete story?',
    downloadFull: 'Download full résumé',
    footerNote: 'Compact, focused, easy to scan',
    tabHint: 'Use the left navigation to switch sections',
    dialogCloseLabel: 'Close project details',
    dialogRole: 'My role',
    dialogOutcome: 'Key outcome',
    dialogTools: 'Tools used',
    dialogNote: 'Add a live link, screenshots, or a complete case study here later.',
    resumeMissing: 'Add your PDF as resume.pdf in the website folder first.'
  }
};

const projectDetails = {
  zh: {
    one: { type:'数据产品 · 2026', title:'项目名称一', summary:'在这里讲清楚项目背景、面对的挑战、你的思考过程以及最终交付。', role:'研究与产品设计', outcome:'效率提升 40%', tools:'Python · SQL · Figma' },
    two: { type:'研究项目 · 2025', title:'项目名称二', summary:'展示你如何收集证据、识别关键问题，并把研究洞察转化为行动建议。', role:'项目负责人', outcome:'完成 20+ 次访谈', tools:'Research · Strategy' },
    three: { type:'个人作品 · 2025', title:'项目名称三', summary:'介绍一个从想法、原型到上线都由你推动的项目，并说明它体现的独特能力。', role:'设计与开发', outcome:'从 0 到 1 上线', tools:'Web · Git · Design' }
  },
  en: {
    one: { type:'Data Product · 2026', title:'Project Name One', summary:'Explain the context, challenge, your reasoning, and what you ultimately shipped.', role:'Research & product design', outcome:'40% efficiency gain', tools:'Python · SQL · Figma' },
    two: { type:'Research Project · 2025', title:'Project Name Two', summary:'Show how you gathered evidence, identified the key problem, and turned insights into action.', role:'Project lead', outcome:'20+ interviews completed', tools:'Research · Strategy' },
    three: { type:'Independent Work · 2025', title:'Project Name Three', summary:'Describe a project you took from concept to prototype and launch, and the strengths it demonstrates.', role:'Design & development', outcome:'Launched from zero to one', tools:'Web · Git · Design' }
  }
};
...
function updateSkillStatus() {
  const count = document.querySelectorAll('.skill-cloud button.is-selected').length;
  const key = count ? 'skillSelected' : 'skillHint';
  document.querySelector('[data-skill-status]').textContent = translations[currentLanguage][key].replace('{count}', count);
}

function fillProjectDialog(projectKey) {
  const project = projectDetails[currentLanguage][projectKey];
  if (!project) return;
  projectDialog.querySelector('.dialog-type').textContent = project.type;
  ...
  projectDialog.querySelector('.dialog-role').textContent = project.role;
  projectDialog.querySelector('.dialog-outcome').textContent = project.outcome;
  projectDialog.querySelector('.dialog-tools').textContent = project.tools;
}
...
function setLanguage(language) {
  ...
  document.querySelector('[data-current-label]').textContent = copy[panelMeta[currentPanel].label];
  updateSkillStatus();
  if (activeProject) fillProjectDialog(activeProject);
  localStorage.setItem('resume-language', lang);
}

function setTheme(theme) {
  root.classList.toggle('dark', theme === 'dark');
  document.querySelector('meta[name="theme-color"]').content = theme === 'dark' ? '#09111b' : '#e8edf3';
  localStorage.setItem('resume-theme', theme);
}

function activatePanel(name, updateHistory = true) {
  if (!panelMeta[name]) name = 'about';
  currentPanel = name;
  navTabs.forEach(tab => {
  ...
  document.querySelector('[data-current-index]').textContent = panelMeta[name].index;
  document.querySelector('[data-current-label]').textContent = translations[currentLanguage][panelMeta[name].label];
  if (updateHistory && location.hash !== `#${name}`) history.pushState({ panel:name }, '', `#${name}`);
}
...
navTabs.forEach((tab, index) => {
  ...
  tab.addEventListener('keydown', event => {
    ...
    let nextIndex = index;
    if (event.key === 'ArrowDown' || event.key === 'ArrowRight') nextIndex = (index + 1) % navTabs.length;
    if (event.key === 'ArrowUp' || event.key === 'ArrowLeft') nextIndex = (index - 1 + navTabs.length) % navTabs.length;
    if (event.key === 'Home') nextIndex = 0;
    if (event.key === 'End') nextIndex = navTabs.length - 1;
    navTabs[nextIndex].focus();
    activatePanel(navTabs[nextIndex].dataset.tab);
  });
});
...
window.addEventListener('popstate', () => activatePanel(location.hash.slice(1) || 'about', false));
...
document.querySelectorAll('.timeline-entry').forEach(entry => {
  ...
  toggle.addEventListener('click', () => {
    ...
    document.querySelectorAll('.timeline-entry').forEach(item => {
      ...
      item.querySelector('.timeline-toggle').setAttribute('aria-expanded', 'false');
      item.querySelector('.timeline-toggle').textContent = '＋';
    });
    if (!wasOpen) {
...
document.querySelectorAll('.project-open').forEach(button => {
  button.addEventListener('click', () => {
    ...
    fillProjectDialog(activeProject);
...
projectDialog.addEventListener('close', () => { activeProject = null; });
...
cards.forEach(card => {
  ...
  card.addEventListener('pointermove', event => {
    ...
    frame = requestAnimationFrame(() => {
      ...
      card.style.setProperty('--rx', `${(.5 - y) * 2.2}deg`);
...
document.querySelectorAll('a[download]').forEach(link => link.addEventListener('click', event => {
  if (location.protocol === 'file:') {
    event.preventDefault();
    toast.textContent = translations[currentLanguage].resumeMissing;
